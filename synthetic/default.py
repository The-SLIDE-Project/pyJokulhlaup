...
md.friction.p = 4*oneelem
md.friction.q = 1*oneelem
md.friction.coefficient = 5e1*onevec
md.friction.coupling = 4
overburden = md.constants.g * md.materials.rho_ice * md.geometry.thickness
md.friction.effective_pressure = overburden

# rheology
print('Creating flow law parameters')
md.materials.rheology_n = 3.*oneelem
md.materials.rheology_B = paterson(273.15-10)*onevec
...
""" RELICT CODE
# Stress balance
print('Setting up stress balance')
