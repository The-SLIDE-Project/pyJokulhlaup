...
\title[2D model of Jökulhlaup]{A physically consistent representation of Jökulhlaup floods in a fully-coupled 2D subglacial hydrology model}
...
\textit{v}$_{\mathrm{b}}$ & $\mathrm{m\,a}^{-1}$ & y-component of basal velocity \\
...
\hline
Schoof friction coefficient & $C_{\mathrm{s}}$ & & \\
...
Our model results also reproduce some of the observations relating to ice-dynamics, including the pattern of ice-velocity following a post-melt season drainage event (Fig.~\ref{FIG:7}). 
...
\subsection{Shortcomings and modelling issues}
