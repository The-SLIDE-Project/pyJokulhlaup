...
The full primary phase of our Greenland simulation and the subglacial channel configuration during peak flood discharge, is shown in Fig~\ref{FIG:5}. At the peak of a flood, close to the end of the 2022 melt season (Fig.~\ref{FIG:5}c), the drainage system of Isunnguata Sermia is characterised by a large channel that occupies the large central trough and extends $>45\mathrm{km}$ upglacier. The majority of surface melt is routed through this `primary drainage axis' towards the ice margin, and an anabranching tributary system is visible upstream. Closer to the terminus, a second drainage axis, comprising a high discharge central channel and two lower discharge subsidary channels, connects the western lake outlet to the primary drainage axis. 
...
The timing of lake highstands in our transient phase aligns well with that in the observed record. Seven clear lake highstands are evident in the model results (Fig.~\ref{FIG:5}f) between 2007--2024, each of which corresponds with an observed lake highstand to within $\sim$2 months (Fig.~\ref{FIG:5}f). Further, There is overall agreement between model and observation for events in which the lake was observed to partially drain (e.g., 2010--2011) rather than drain completely (e.g., 2007--2008) though this match is not perfect (e.g., 2013) and is likely partly influenced by gaps in the observational record \citep{livingstone2025ice}. 
