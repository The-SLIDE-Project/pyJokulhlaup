...
\begin{figure}[!h]
\centering{\includegraphics{./figures/Figure_1/Figure1.png}}
\caption{Schematic illustration of our model. \textbf{a}) Oblique view showing an ice-marginal lake connected two-ways to a subglacial channel and sheet. This in turn modifies basal velocity, $u_{\mathrm{b}}$ through effective pressure, $N$. \textbf{b}) plan view of the same system. Note, although the ice-marginal lake is shown as connected to one channel, in our model an ice-marginal lake can be connected to the subglacial system at multiple outlets. \texttt{[SINGLE-COLUMN]}}
\label{FIG:1}
\end{figure}
